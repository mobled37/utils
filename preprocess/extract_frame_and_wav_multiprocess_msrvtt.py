...
input_path = '/Users/valleotb/Downloads/MSRVTT_Videos'
output_path = '/Users/valleotb/Downloads/MSRVTT_extract'
...
def extract_thread(video_id):
    try:
        ...
        print(f'Error in extract_thread: {e}')
        traceback.print_exc()  # Don't forget to import traceback at the beginning of your file
